  ...
  group "mc-atm9" {
    ...
    task "mc-atm9" {
      ...
      env {
        ...
        UID = 1001
        GID = 1001
        SERVER_NAME = "§f-§8=§cB§ba§er§al§9o§6w §dC§cr§ba§ef§at§8=§f- §aATM9"
        MODE = "survival"
        DIFFICULTY = "hard"
        ALLOW_FLIGHT = "TRUE"
        ...
        OPS = "netlobo"
        MOTD = "\u00a7f-\u00a78=\u00a7cB\u00a7ba\u00a7er\u00a7al\u00a79o\u00a76w \u00a7dC\u00a7cr\u00a7ba\u00a7ef\u00a7at\u00a78=\u00a7f- \u00a7aATM9"
        TYPE = "FORGE"
        GENERIC_PACK = "/modpacks/Server-Files-0.0.36.zip"
        VERSION = "1.20.1"
